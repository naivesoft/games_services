...
class MethodChannelGamesServices extends GamesServicesPlatform {
  ...
  @override
  Future<String?> getPlayerAvatar() async {
    return await _channel.invokeMethod("getPlayerAvatar");
  }

  @override
  Future<String?> getPlayerIconAvatar() async {
    return await _channel.invokeMethod("getPlayerIconAvatar");
  }
